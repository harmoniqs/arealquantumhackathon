...
export const metadata: Metadata = {
  title: "schedule",
  description: `${site.eventDateFull} — ${site.venue}.`,
};

const blocks = [
  { time: "09:00", label: "doors" },
  { time: "09:30", label: "welcome" },
  { time: "10:00", label: "keynote" },
  { time: "10:45", label: "challenge briefing" },
  { time: "11:00", label: "hacking begins" },
  { time: "13:00", label: "lunch" },
  { time: "15:30", label: "final submissions" },
  { time: "16:00", label: "judging" },
  { time: "16:45", label: "awards" },
];
...
export default function SchedulePage() {
  return (
    <div className="mx-auto max-w-3xl px-4 pb-24 pt-32 sm:px-6">
      ...
      <h1 className="pixel-h text-balance text-5xl sm:text-7xl">One day.</h1>
      <p className="mt-5 text-sm leading-relaxed text-fg-muted">
        {site.eventDateFull} · {site.venue}
      </p>
